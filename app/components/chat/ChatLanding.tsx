  ...
  return (
    ...
    >
      ...
      <motion.div className="mb-8 text-center" variants={itemVariants}>
        <h2 className="mb-3 text-2xl font-semibold">I'm Ansh's AI Portfolio</h2>
        <p className="text-muted-foreground mx-auto max-w-md">
          Ask me anything about Ansh's projects, skills, or experience!
        </p>
      </motion.div>
      ...
      <motion.div className="w-full max-w-md space-y-3" variants={containerVariants}>
        {suggestedQuestions.map((question, index) => (
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
          >
            <span className="bg-background mr-3 rounded-full p-2">{question.icon}</span>
